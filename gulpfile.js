...
function imgMin(){
        return  src('./images/*')
        .pipe(imagemin())
        .pipe(dest('./minify/images'));
  
}
// JS task: concatenates and uglifies JS files to script.js
function jsTask(){
    return src([
        files.jsPath ,'!' + './js/jquery.min.js', // to exclude any specific files
        //files.jsPath ,'!' + './js/intlTelInput.min.js',
...
exports.default = series( parallel(scssTask,imgMin),watchTask,browserWatch);
